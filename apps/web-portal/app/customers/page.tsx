...
export default async function CustomersPage() {
  ...
  return (
    <AppShell>
      ...
      {error ? <DataError message={error.message} /> : <DataTable rows={data ?? []} emptyTitle="No customers found" emptyDescription="Create a customer in Supabase to begin managing commercial vehicle claims." columns={[
